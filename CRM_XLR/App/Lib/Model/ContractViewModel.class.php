<?php 
	class contractViewModel extends ViewModel {
	   public $viewFields = array(
		'contract'=>array('contract_id','number','business_id','is_deleted','start_date','end_date','delete_role_id','delete_time','price','due_time','content','creator_role_id','owner_role_id','description','ok_date','create_time','update_time','status','ht_type','_type'=>'LEFT'),

				...
				<div class="span12">
					<ul class="nav pull-left">
						...
						<li class="pull-left" style="margin-left: 10px;">
							<input type="text" style="width: 100px;" name="user_name" id="user_name" placeholder="用户名">
							<input type="button" class="btn btn-primary" id="show_user" value="搜索">
						</li>
					</ul>
...
<script type="text/javascript">
	...
	$("#show_user").click(function(){
		...
		var url = "index.php?m=user&a=index&user_name="+user_name;
		self.location=url;
	})
</script>
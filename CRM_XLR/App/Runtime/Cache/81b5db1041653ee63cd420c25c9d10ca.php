...
<div class="row " >
    <div class="span2 bs-docs-sidebar mar-left3" >
        <ul class="nav nav-list bs-docs-sidenav span2 widths" id="left_list" >
            ...
            <li><a href="#tab2"><?php echo L('LINKMAN');?>&nbsp;&nbsp;<span class="badge badge-success"><?php if($customer['contacts_count']): echo ($customer['contacts_count']); endif; ?></span></a></li>
                ...
                <?php else: ?>
                    <?php if(is_array($customer["log"])): $i = 0; $__LIST__ = $customer["log"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="caption">
						...
						<div class="editors">
							...
							<img src="__PUBLIC__/img/time_annoce.png"/>&nbsp;<span class=" name-colors" ><?php echo (date("Y-m-d  H:i:s",$vo["create_date"])); ?></span> &nbsp; 
        ...
        <div class="tab-pane fade back_box" id="tab2">
            ...
            <table class="table table-hover">
                ...
                <?php else: ?> 
                    <tr>
                        <td width="18%">&nbsp;</td>
                        <td width="21%"><?php echo L('NAME');?></td>
                ...
                <?php else: ?> 
                    ...
                    <?php if(is_array($customer["event"])): $i = 0; $__LIST__ = $customer["event"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tdleft">
                                ...
                                <?php if($vo["isclose"] == 0): ?><a href="<?php echo U('event/close','id='.$vo['event_id']);?>"><?php echo L('CLOSE');?></a><?php elseif($vo["isclose"] == 1): ?><a href="<?php echo U('event/close','id='.$vo['event_id']);?>"><?php echo L('OPEN');?></a><?php endif; endif; ?>
                            </td>
                            <td>
                                <?php echo ($vo["subject"]); ?>
                            </td>
        ...
        <div class="tab-pane fade back_box" id="tab4">
            ...
            <?php else: ?> 
                ...
                <?php if(is_array($customer["file"])): $i = 0; $__LIST__ = $customer["file"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <a href="<?php echo ($vo["file_path"]); ?>"><?php echo ($vo["name"]); ?></a>
                        </td>
                        <td>

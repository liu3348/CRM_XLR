...
<div class="container">
	...
	<div class="page-header" style="border:none; font-size:14px; ">
		<ul class="nav nav-tabs">
		  ...
		  <li><a href="http://crm.com/index.php?m=doc&a=index&id=27" target="_blank" style="font-size: 12px;color: rgb(255, 102, 0);"><img width="20px;" src="__PUBLIC__/img/help.png"/> <?php echo L('HELP');?></a></li>
		</ul>
	</div>

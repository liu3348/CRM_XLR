...
<script src="__PUBLIC__/js/change.js" type="text/javascript"></script>
<div class="container customer-index">
    ...
    <div class="customer-index-view">
        ...
        <?php if($_GET['content'] != 'resource'): ?><p class="view">
                ...
                <a href="<?php echo U('customer/index','by=deleted');?>" <?php if($_GET['by']== 'deleted'): ?>class="active"<?php endif; ?>>
                </span>
                <img src="__PUBLIC__/img/task_garbage.png"/> <?php echo L('RECYCLE_BIN');?></a>
                &nbsp; <img src=" __PUBLIC__/img/seach.png"/><a href="<?php echo U('customer/search');?>"><?php echo L('ADVANCED_SEARCH');?></a>
            </p><?php endif; ?>
    </div>
    <div class="row">
        <div class="span12 clearfix xs-coustomer-index">
            <ul class="nav pull-left">
                <li >
                    <form class="form-inline" id="searchForm" action="index.php" method="get">
                        <ul class="nav pull-left ">
                            <li class="pull-left xs-coustomer-li">
                                <div class="pull-left">
                                    <?php if($_SESSION['admin']== 1 or $_GET['by']!= 'deleted'): ?><div class="btn-group pull-left xs-coustomer-index-1">
                                ...
                                <div class="pull-left xs-coustomer-index-2" >
                                ...
                                <div id="conditionContent" class="pull-left xs-coustomer-index-2">
                                    <select id="condition"  name="condition" onchange="changeSearch()">
                            ...
                            <li id="searchContent" class="pull-left xs-coustomer-index-search xs-coustomer-li">
                                <span class="xs-index-hide">&nbsp;&nbsp;</span>
                            ...
                            <li class="pull-left xs-coustomer-li xs-coustomer-send">
                                <div class="btn-group">
                                    <a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
        ...
        <div class="span12 index-info-tab">

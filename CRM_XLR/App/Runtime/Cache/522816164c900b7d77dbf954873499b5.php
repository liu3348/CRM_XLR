		...
		<div class="span12">
			...
			<table class="table table-hover table-striped table_thead_fixed">
				<?php if(!empty($list)): ?><thead>
					...
					<tfoot>
						<?php if($_GET['by']== 'deleted'): ?><tr><td id="td_colspan"><p><?php echo L('INFUSE');?> <img src="__PUBLIC__/img/task_owner.png"/> <?php echo L('I_AM_IN_CHARGE_OF_THE');?> &nbsp; <img src="__PUBLIC__/img/task_creator.png"/><?php echo L('I_CREATED');?> &nbsp; </p><?php echo ($page); ?></td></tr>
						<?php else: ?><tr><td id="td_colspan"><p><?php echo L('INFUSE');?> <img src="__PUBLIC__/img/task_owner.png"/> <?php echo L('I_AM_IN_CHARGE_OF_THE');?> &nbsp; <img src="__PUBLIC__/img/task_creator.png"/><?php echo L('I_CREATED');?> &nbsp; </p><?php echo ($page); ?></td></tr><?php endif; ?>
					</tfoot>
					<tbody>

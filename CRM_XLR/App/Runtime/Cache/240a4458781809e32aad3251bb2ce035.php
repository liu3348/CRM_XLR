					...
					<ul class="nav pull-left">
						<li class="pull-left">
							<select style="width:auto" name="field" id="field" onchange="changeCondition()">
								...
								<option class="word" value="presentation">情况说明</option>
			...
			<div class="pull-right">
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						...
						<li><a id="import_excel" class="link" href="javascript:void(0);"><i class="icon-upload"></i> 导入日程</a></li>
				...
				<table class="table table-hover table-striped table_thead_fixed">
					...
					<tbody>
						<?php if(is_array($eventlist)): $i = 0; $__LIST__ = $eventlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><?php echo cutString($vo['presentation'],10);?></td>
